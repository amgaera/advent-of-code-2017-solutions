...
[<Fact>]
let ``The checksum of the example spreadsheet is 18`` () =
    let spreadsheet =
        [ [ 5; 1; 9; 5 ];
          [ 7; 5; 3 ];
          [ 2; 4; 6; 8 ] ]
    ...
    let result = Solution.computeSpreadsheetChecksum spreadsheet
    Assert.Equal(18, result)

[<Fact>]
let ``The checksum of my advent spreadsheet is 53460`` () =
    let spreadsheet =
