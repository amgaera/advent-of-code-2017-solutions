...
[<Fact>]
let ``The result for the example spreadsheet is 9`` () =
    let spreadsheet =
        [ [ 5; 9; 2; 8 ];
          [ 9; 4; 7; 3 ];
          [ 3; 8; 6; 5 ] ]
    ...
    let result = Solution.computeSpreadsheetResult spreadsheet
    Assert.Equal(9, result)

[<Fact>]
let ``The result for my advent spreadsheet is 282`` () =
    let spreadsheet =
